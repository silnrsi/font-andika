...
py C:\Users\wardak\Mine\smith_vm\font-andika\tools\psfgenftml.py "source\Andika-Regular.ufo" "tests\DiacsAR.ftml" -t diac -f A -i "source\glyph_data.csv" -s "../results/Andika-Regular.ttf" --scale 200 -l "tests\logs\Diacs_AR.log"
