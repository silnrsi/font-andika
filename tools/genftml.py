...
for test in test_lst:
    ...
    arg_lst.extend(["-s", "../references/v6001/Andika-Regular.ttf=AR6"])
    arg_lst.extend(["-s", "../references/v6001/Andika-Bold.ttf=AB6"])
    arg_lst.extend(["-s", "../references/v6001/Andika-Italic.ttf=AI6"])
    arg_lst.extend(["-s", "../references/v6001/Andika-BoldItalic.ttf=ABI6"])
