...
*Please note that this release is a beta test and likely contains bugs
...
Andika provides glyphs for a wide range of Latin and Cyrillic characters.
Please read the documentation on the website
(http://software.sil.org/andika) to see what ranges are supported. 
...
See the website (http://software.sil.org/andika) for frequently
...
CONTACT
========
For more information please visit the Andika site:
http://software.sil.org/andika

You can support this project through financial contributions:
https://donate.givedirect.org/?cid=13536
